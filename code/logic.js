...
function selectAnswer(e) {
    ...
    if (correct) {
        checkAnswerEl.innerHTML = "Ты абсолютно прав!";
        score = score + 10;
    } else {
        selectedButton.setAttribute('id','uncorrect')
        checkAnswerEl.innerHTML = "Это неверный ответ.";
     /*   if (timeLeft <= 10) {
            timeLeft = 0;
        } else {
...
function saveScore() {
    ...
    setTimeout(function () {
        ...
        document.getElementById("your-score").textContent = "Твой финальный счет " + score;//timeLeft;
